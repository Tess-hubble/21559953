...
```{r Figure1,  warning =  FALSE, fig.align = 'center', fig.cap = "Frequency of genres among popular series  \\label{Figure1}", fig.ext = 'png', fig.height = 5, fig.width = 10}
...
```{r Figure2, warning =  FALSE, fig.align = 'center', fig.cap = "Frequency of genres among popular movies \\label{Figure2}", fig.height = 5, fig.width =10, dev = 'png'}
...
The table below shows the most popular actors, their average imdb rating and their most popular movie or series performance. 
It becomes clear that including series in a streaming performance is of the utmost importance. Moreso, including very popular series within the last two decades should bring in users to the platform. Series and movies with the following actors are likely to incentivise users to join. 

```{r Figure3, warning =  FALSE, fig.align = 'center', fig.cap = "Top 20 most popular actors and their their most popular series/movies appearance \\label{Figure3}", fig.height = 5, fig.width = 7, dev = 'png'}
